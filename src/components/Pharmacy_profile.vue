                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="provider_avatar">
                                ...
                                <router-link :to="{ path: '/search/2/Lagos' }"><i id="bck" class="fa fa-arrow-left pull-right"></i> </router-link>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="pro-details">
                              <router-link :to="{ path: '/search/2/Lagos' }"><i id="back" class="fa fa-arrow-left pull-right"></i></router-link>
                                <h3>{{ result.business_name }}</h3>
                                <h6 class=""><i class="fa fa-map-pin ic"></i>{{ result.address }}</h6>
                                <h6 v-if="result.status == 0" class="unverified"><i class="fa fa-thumbs-down"></i>&nbsp; Pharmacy registration not verified</h6>
                                <h6 v-else class="verified"><i class="fa fa-thumbs-down"></i>&nbsp; Pharmacy registration not verified</h6>
                                ...
                                <div class="buttons">
                                    <span><a v-if="result.profile" target="_blank" :href="'https://www.google.com/maps/dir/'+direction+'/'+result.profile.address+'/?hl=en-US'" class="btn____ btn-login btn-sm"><i class="fa fa-map-marker"></i>&nbsp; Get Direction</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tbody>
                                            <!-- <tr>
                                                <th><i class="fa fa-edit ic"></i>&nbsp; CAC Reg. No:</th>
                                                <td>AF1234</td>
                                            </tr> -->

                                            <tr>
                                                <th><i class="fa fa-edit ic"></i>&nbsp; Licence No:</th>
                                            ...
                                            <tr>
                                                <th><i class="fa fa-user ic"></i>&nbsp; Pharmaceutical Reg. Bodies:</th>
                            ...
                            <div class="col-md-6 col-xs-12 pro-details">
                                <ul class="list-group">
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        Deliveries
                                        <span class="badge badge-success badge-pill" v-if="result.delivery_type" v-for="(delivery,index) in result.delivery_type"><i class="fa fa-check"></i>{{ delivery[index] }}&nbsp;</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        Payment Modes
                                        <span class="badge badge-success badge-pill" v-if="result.payment_method" v-for="(delivery,index) in result.payment_method"><i class="fa fa-check"></i>{{ delivery[index] }}&nbsp;</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
