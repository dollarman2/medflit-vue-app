<template>
    <div class="row">
        <div class="header-bg3 partner-page-area">
                            ...
                            <!-- Start Portfolio -page -->
                                ...
                                <div class="awesome-project-content">
                                    ...
                                    <div class="single-awesome-project">
                                        ...
                                        <a href="#"><img src="../../static/img/slider/citistallion.jpg" alt="" /></a>
                                        <div class="add-actions text-center">
                                            <div class="project-dec">
                                            <a class="venobox" data-gall="myGallery" href="../../static/img/slider/citistallion.jpg">
                                    ...
                                    <div class="single-awesome-project">
                                        <div class="awesome-img">
                                        <a href="#"><img src="../../static/img/slider/caleb-university.jpg" alt="" /></a>
                                        <div class="add-actions text-center">
                                            <div class="project-dec">
                                            <a class="venobox" data-gall="myGallery" href="../../static/img/slider/caleb-university.jpg">
                                    ...
                                    <div class="single-awesome-project">
                                        <div class="awesome-img">
                                        <a href="#"><img src="../../static/img/slider/corona-high.jpeg" alt="" /></a>
                                        <div class="add-actions text-center">
                                            <div class="project-dec">
                                            <a class="venobox" data-gall="myGallery" href="../../static/img/slider/corona-high.jpeg">
                                    ...
                                    <div class="single-awesome-project">
                                        <div class="awesome-img">
                                        <a href="#"><img src="../../static/img/slider/winners-chapel.jpg" alt="" /></a>
                                        <div class="add-actions text-center">
                                            <div class="project-dec">
                                            <a class="venobox" data-gall="myGallery" href="../../static/img/slider/winners-chapel.jpg">
                                    ...
                                    <div class="single-awesome-project">
                                        <div class="awesome-img">
                                        <a href="#"><img src="../../static/img/slider/redeem-church.jpg" alt="" /></a>
                                        <div class="add-actions text-center text-center">
                                            <div class="project-dec">
                                            <a class="venobox" data-gall="myGallery" href="../../static/img/slider/redeem-church.jpg">
                                                <h4>Redeem Church</h4>
                                                <span>Churches</span>
                                            </a>
                                            </div>
